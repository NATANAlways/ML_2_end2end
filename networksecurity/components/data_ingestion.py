...
from networksecurity.entity.artifact_entity import DataIngetsionArtifacts
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            ...
            logging.info("Export train and test file")
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            data_ingestion_artifact = DataIngetsionArtifacts(
